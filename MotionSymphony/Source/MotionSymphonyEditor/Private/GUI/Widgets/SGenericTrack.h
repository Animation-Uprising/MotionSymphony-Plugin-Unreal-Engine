...
typedef TSet<const class SGenericTrackNode*> STrackNodeSelectionSet;
...
public:
	...
	static TSharedRef<FTrackNodeDragDropOp> New(TSharedRef<SGenericTrackNode> TrackNode, const FVector2D& CursorPosition, const FVector2D& ScreenPositionOfNode);
...
protected:
	...
	TWeakPtr<class SGenericTrackNode>		OriginalTrackNode;
	TWeakPtr<class SGenericTrack>			OriginalTrack;
	...
	friend class SGenericTrack;
	friend class SGenericTrackNode;
};

/** class SGenericTrackNode for SGenericTrack.
 * This is Children for SGenericTrack
 */
class SGenericTrackNode : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SGenericTrackNode)
		: _ViewInputMin()
		, _ViewInputMax()
		, _DataLength()
		, _DataStartPos()
...
class SGenericTrack : public SPanel
{
public:

	SLATE_BEGIN_ARGS(SGenericTrack)
		: _ViewInputMin()
		, _ViewInputMax()
		, _TrackMaxValue()
		, _TrackMinValue()
	...
	void				AddTrackNode(TSharedRef<SGenericTrackNode> Node);
	void				ClearTrack();
...
protected:
	...
	TSlotlessChildren< SGenericTrackNode >			TrackNodes;
