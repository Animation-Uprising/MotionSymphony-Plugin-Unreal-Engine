...
public:
	FMotionTimelineTrack(const FText& InDisplayName, const FText& InToolTipText, /*const TSharedPtr<FAnimModel>& InModel,*/ bool bInIsHeaderTrack = false)
		: /*Model(InModel),*/
	...
	virtual void AddContextMenu(FMenuBuilder& InMenuBuilder, TSet<FName>& InOutExistingMenuTypes) const;
