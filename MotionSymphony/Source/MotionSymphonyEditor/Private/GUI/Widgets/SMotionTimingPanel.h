...
//////////////////////////////////////////////////////////////////////////
// The content of SMotionTimingTrackNode, separated to be used in non SGenericTrack widgets
//////////////////////////////////////////////////////////////////////////
class SMotionTimingNode : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SMotionTimingNode)
		: _InElement()
		, _bUseTooltip(true)
	{}
...
//////////////////////////////////////////////////////////////////////////
class SMotionTimingTrackNode : public SGenericTrackNode
{
public:
	SLATE_BEGIN_ARGS(SMotionTimingTrackNode)
		: _bUseTooltip(true)
	{}
...
//////////////////////////////////////////////////////////////////////////
class SMotionTimingPanel : public SMotionTrackPanel
{
public:

	SLATE_BEGIN_ARGS(SMotionTimingPanel)
		: _InSequence(nullptr)
		, _WidgetWidth(0)
		, _CurrentPosition(0)
		, _ViewInputMin(0)
	...
	SLATE_ARGUMENT(UAnimSequenceBase*, InSequence)
		...
		void Construct(const FArguments& InArgs/*, const TSharedRef<FMotionModel_AnimMontage>& InModel*/);
...
protected:
	...
	//TWeakPtr<FMotionModel_AnimMontage> WeakModel;
	...
	TSharedPtr<SGenericTrack> Track;
};