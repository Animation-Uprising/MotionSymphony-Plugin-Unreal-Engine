...
//const int32 MAX_NODE_OBJECT_INTERFACE_SIZE = CompileTimeMax<sizeof(FTagNodeInterface), sizeof(FSyncMarkerNodeInterface)>::VALUE;
//
//
////////////////////////////////////////////////////////////////////////////
//// SMotionTagNode
...
//	TSharedPtr<class SMotionTagTrack>	;
//
...
//}
//
//void SMotionTagTrack::FillNewSyncMarkerMenu(FMenuBuilder& MenuBuilder)
//{
//	USkeleton* SeqSkeleton = Sequence->GetSkeleton();
//	if (SeqSkeleton)
//	{
...
//			FUIAction UIAction;
//			UIAction.ExecuteAction.BindSP(
//				this, &SMotionTagTrack::OnNewSyncMarkerClicked);
...
//}
//
//void SMotionTagTrack::CreateNewSyncMarkerAtCursor(FString NewSyncMarkerName, UClass* NotifyClass)
//{
...
//							];
//
//						MenuBuilder.AddWidget(NotifyStateDurationWidget, LOCTEXT("SetMotionSateDuration", "Motion Tag State Duration"));
//
//						TSharedRef<SWidget> NotifyStateDurationFramesWidget =
//							SNew(SBox)
//							.HAlign(HAlign_Right)
//							.ToolTipText(LOCTEXT("SetMotionStateDurationFrames_ToolTip", "The duration of this Motion Tag State in frames"))
//							[
//								SNew(SBox)
//								.Padding(FMargin(4.0f, 0.0f, 0.0f, 0.0f))
//							.WidthOverride(100.0f)
...
//									if (InCommitType == ETextCommit::OnEnter && AnimNotifies.IsValidIndex(NotifyIndex))
//									{
//										float NewDuration = FMath::Max(Sequence->GetTimeAtFrame(InValue), SMotionTagNode::MinimumStateDuration);
//										float MaxDuration = Sequence->SequenceLength - AnimNotifies[NotifyIndex]->GetTime();
//										NewDuration = FMath::Min(NewDuration, MaxDuration);
//										AnimNotifies[NotifyIndex]->SetDuration(NewDuration);
//
...
//							];
//
//						MenuBuilder.AddWidget(NotifyStateDurationFramesWidget, LOCTEXT("SetMotionStateDurationFrames", "Motion Tag State Frames"));
//					}
//				}
//			}
//		}
...
//					FNewMenuDelegate::CreateRaw(this, &SMotionTagTrack::FillNewSyncMarkerMenu));
//			}
//
...
//					{
//						MenuBuilder.AddSubMenu(
//							NSLOCTEXT("NewTagSubMenu", "NewTagSubMenuReplaceWithNotifyState", "Replace with Tag State..."),
//							NSLOCTEXT("NewTagSubMenu", "NewTagSubMenuReplaceWithNotifyStateToolTip", "Replace with MotionTagState"),
...
//}
//
//void SMotionTagTrack::OnNewSyncMarkerClicked()
//{
//	// Show dialog to enter new track name
//	TSharedRef<STextEntryPopup> TextEntry =
//		SNew(STextEntryPopup)
//		.Label(LOCTEXT("NewSyncMarkerLabel", "Sync Marker Name"))
//		.OnTextCommitted(this, &SMotionTagTrack::AddNewSyncMarker);
//
//	// Show dialog to enter new event name
//	FSlateApplication::Get().PushMenu(
//		AsShared(), // Menu being summoned from a menu that is closing: Parent widget should be k2 not the menu thats open or it will be closed when the menu is dismissed
...
//	{
//		const FScopedTransaction Transaction(LOCTEXT("AddNewNotifyEvent", "Add New Motion Tag"));
...
//}
//
//void SMotionTagTrack::AddNewSyncMarker(const FText& NewNotifyName, ETextCommit::Type CommitInfo)
//{
//	USkeleton* SeqSkeleton = Sequence->GetSkeleton();
//	if ((CommitInfo == ETextCommit::OnEnter) && SeqSkeleton)
//	{
...
//		SMotionTimingPanel::GetTimingRelevantElements(Sequence, TimingElements);
...
//	{
//		TSharedPtr<SMotionTagNode> AnimSyncMarkerNode = nullptr;
//		TSharedPtr<SMotionTimingNode> EndTimingNode = nullptr;
//
//		const int32 NodeIndex = NotifyNodes.Num();
//		SAssignNew(AnimSyncMarkerNode, SMotionTagNode)
//			.Sequence(Sequence)
//			.AnimSyncMarker(SyncMarker)
//			.OnNodeDragStarted(this, &SMotionTagTrack::OnTagNodeDragStarted, NodeIndex)
//			.OnUpdatePanel(OnUpdatePanel)
//			.PanTrackRequest(OnRequestTrackPan)
//			.ViewInputMin(ViewInputMin)
//			.ViewInputMax(ViewInputMax)
...
//
//		NodeSlots->AddSlot()
//			.Padding(TAttribute<FMargin>::Create(TAttribute<FMargin>::FGetter::CreateSP(this, &SMotionTagTrack::GetSyncMarkerTrackPadding, NodeIndex)))
//			[
...
//}
//
//void SMotionTagTrack::PasteSingleSyncMarker(FString& MarkerString, float PasteTime)
//{
...
//		TagMotionTracks, Sequence, ScreenCursorPos, OverlayOrigin, OverlayExtents, CurrentDragXPosition, 
...
//		}
//
//		FTagNodeInterface::RemoveInvalidNotifies(Sequence);
...
//}
//
//void SMotionTagPanel::SetSequence(class UAnimSequenceBase* InSequence)
//{
...
//
//		for (int32 TrackIdx = 0; TrackIdx < TagMotionTracks.Num(); ++TrackIdx)
//		{
//			TSharedPtr<SMotionTagTrack> Track = TagMotionTracks[TrackIdx];
...
//					NewNotifyObject->InitFromAnim(Sequence, FOnAnimObjectChange::CreateSP(this, &SMotionTagPanel::OnTagObjectChanged));
...
//	SelectedNodes.Sort();
//
//	const FScopedTransaction Transaction(LOCTEXT("ReplaceAnimNotify", "Replace Motion Tag"));
//	Sequence->Modify(true);
//
//	for (INodeObjectInterface* NodeObject : SelectedNodes)
//	{
...
//			}
//
//			// For Motion Tag States, handle the end time and link
...
//			{
//				if (TagMotionTracks.IsValidIndex(Notify.TrackIndex))
//				{
//					TagMotionTracks[Notify.TrackIndex]->Update();
//				}
//			}
//		}
//	}
