...
#include "MatchFeature_BoneLocationAndVelocity.generated.h"
...
class MOTIONSYMPHONY_API UMatchFeature_BoneLocationAndVelocity : public UMatchFeatureBase
{
	GENERATED_BODY()
	
public:
	UPROPERTY(EditAnywhere, Category = "Match Feature")
	float DefaultVelocityWeighting;

	
	UPROPERTY(EditAnywhere, Category = "Match Feature|Bone")
